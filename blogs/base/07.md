...
- 读文本文件
  ...
  #	- 路径：
  #		相对路径：'info.txt'
  #		绝对路径：'/Users/xx/xx/xx/xx/info.txt'
  # 	- 模式
...
- 路径
  ...
  ```python
    # 1.打开文件
  file_object = open('/Users/xx/xx/xx/xx/info.txt', mode='rt', encoding='utf-8')
    # 2.读取文件内容，并赋值给data
  data = file_object.read()
    # 3.关闭文件
  file_object.close()
...
- 读文件时，文件不存在程序会报错。
  ...
  Traceback (most recent call last):
    File "/Users/xx/xx/xx/xx/2.读文件.py", line 2, in <module>
  ...
  file_path = "/Users/xx/xx/xx/xx/info.txt"
...
file_object = open("t1.txt", mode='wb')
    ...
    # 2.写入内容
file_object.write(    "admin".encode("utf-8")    )
...
5. 根据要求修改文件的内容，原文件内容如下：`ha.conf`
   ...
   frontend ok.org
           ...
           option  forwardfor
           log global
           acl www hdr_reg(host) -i www.baidu.org
           use_backend www.baidu.com if www
...
with open('files/ha.conf', mode='r', encoding='utf-8') as read_file_object, open('files/new.conf', mode='w',
    ...
    for line in read_file_object:
        new_line = line.replace("baidu", 'pythonav')
...
# config.read('/Users/xx/xx/xx/files/my.ini', encoding='utf-8')
...
# config.set('group','name','admin')
# config.set('client','name','admin')
...
- 读取所有节点
  ...
  config = configparser.ConfigParser()
  config.read('/Users/xx/xx/xx/my.conf', encoding='utf-8')
...
- 读取节点下值（根据 节点+键 ）
  ...
  config = configparser.ConfigParser()
  config.read('/Users/xx/xx/xx/files/my.conf', encoding='utf-8')
...
- 检查、删除、添加节点
  ...
  # 内容写入新文件
  config.write(open('/Users/xx/xx/xx/xxoo.conf', 'w'))
  ...
  config.write(open('/Users/xx/xx/xx/files/new.conf', 'w'))
  ```
...
例如：在`/Users/aa/aa/aa/`路径下编写 `demo.py`文件
...
- 方式2，文件会创建在 `/Users/bb`目录下。

  ```
  cd /Users/bb
  python /Users/aa/aa/aa/demo.py
  ```
...
print(abs) # /Users/aa/aa/aa/20.路径相关.py
path = os.path.dirname(abs)
print(path) # /Users/aa/aa/aa
"""
...
# 8. 拷贝文件夹
"""
shutil.copytree("/Users/aa/Desktop/图/csdn/","/Users/aa/PycharmProjects/CodeRepository/files")
"""

# 9.拷贝文件
"""
shutil.copy("/Users/aa/Desktop/图/csdn/WX20201123-112406@2x.png","/Users/aa/PycharmProjects/CodeRepository/")
shutil.copy("/Users/aa/Desktop/图/csdn/WX20201123-112406@2x.png","/Users/aa/PycharmProjects/CodeRepository/x.png")
"""

# 10.文件或文件夹重命名
"""
shutil.move("/Users/aa/PycharmProjects/CodeRepository/x.png","/Users/aa/PycharmProjects/CodeRepository/xxxx.png")
shutil.move("/Users/aa/PycharmProjects/CodeRepository/files","/Users/aa/PycharmProjects/CodeRepository/images")
"""
```
...
4. 补充代码，实现如下功能。
   ...
   # 1.下载文件
   file_url = 'https://files.cnblogs.com/bb/aa/HtmlStore.zip'
